var projects = [
    ...
    {visible: true, name: "Camp champ", description: "A 2 vs 2 game of capture the flag made using the Unreal engine.", imageURL: "CampChampThumbnail.png", project: "CampChamp"},
