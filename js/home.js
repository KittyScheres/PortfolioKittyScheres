var projects = [
    ...
    {visible: true, name: "[WIP] On the bubble", description: "A custom engine based game inspired by the game \"Super Monkey Ball\" with a big focus on user generated content.", language: "C++", duration: "32 weeks",  type: "Custom engine", teamSize: "13 people", platforms: "Windows/PS5", teamRole: "Generalist programmer", developmentYear: "2023-2024", imageURL: "BallThumbnail.png", project: "OnTheBubble"},
    {visible: true, name: "Wombat combat engine", description: "A custom FPS engine that uses TrechBroom as its level editor.", language: "C++", duration: "16 weeks", type: "Custom engine", teamSize: "7 people", platforms: "Windows/PS5", teamRole: "Engine programmer", developmentYear: "2022-2023", imageURL: "WombatCombatThumbnail.png", project: "FPSEngine"},
    {visible: true, name: "Camp champ", description: "A 2 vs 2 game of capture the flag made using the Unreal engine.", language: "Unreal blueprints", duration: "12 weeks", type: "Game", teamSize: "14 people", platforms: "Windows", teamRole: "Tech lead", developmentYear: "2023", imageURL: "CampChampThumbnail.png", project: "CampChamp"},
];
