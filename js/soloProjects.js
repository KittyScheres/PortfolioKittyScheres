var projects = [
    ...
    {visible: false, name: "[WIP] Constructive Solid Geometry", description: "An implementation of constructive solid geometry with the C++ programming language.", language: "C++", duration: "Unknown", type: "Research", platforms: "Windows", imageURL: "DefaultThumbnail.png", project: "CSG"},
    {visible: true, name: "OpenXR tutorial", description: "An openXR tutorial I followed to get a better understanding of how to implement AR/VR into my own projects.", language: "C++", duration: "8 weeks", type: "Research", platforms: "Windows", imageURL: "DefaultThumbnail.png", project: "OpenXrTutorial"},
];
